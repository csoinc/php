...
// page title
define('TITLE', 'Canuck Badminton Store');

// Site Tagline
define('SITE_TAGLINE', 'apacs black knight head yonex dealer badminton shoes racques rackets shuttlecocks uniforms shirts shorts bags Toronto Ontario Canada');

// Custom Keywords
define('CUSTOM_KEYWORDS', 'badminton racquets rackets shuttlecocks shoes shirts shorts bads string yonex apacs black knight head uniforms stringing service');
...
define('FAVICON','images/canuckvb.ico');
