...
// Show "Details" button.
  function zen_get_details_button($product_id, $link, $additional_link = false) {
    global $db;

// show case only superceeds all other settings
        return '<a href="' . zen_href_link(zen_get_info_page($product_id), 'products_id=' . $product_id) . '">' . /*MORE_INFO_TEXT*/ zen_image_button(BUTTON_IMAGE_DETAILS, BUTTON_IMAGE_DETAILS_ALT, 'class="listingBuyNowButton"') . '</a>';
  }
