...
define('FILENAME_STATS_CASH_REPORT', 'stats_cash_report');
define('FILENAME_STATS_CUSTOMERS', 'stats_customers');
define('FILENAME_STATS_CUSTOMERS_EX', 'stats_customers_ex');
...
define('FILENAME_STATS_AGE_REPORT', 'stats_age_report');
