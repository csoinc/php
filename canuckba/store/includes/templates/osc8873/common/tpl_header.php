	...
	<TR>
		<TD>
			<TABLE id="main_header" CELLSPACING=0 CELLPADDING=0>
				<TR>
					<TD height="70" width="700px">
					<A HREF=<?php echo zen_href_link('index'); ?> title="Canuck Badminton Store"><IMG SRC="images/blank2x2.gif" WIDTH=390 HEIGHT=70> </A>
					<A HREF="http://www.canuckstuff.com/store/" title="Canuck Volleyball Store"><IMG SRC="images/blank2x2.gif" WIDTH=190 HEIGHT=70> </A>
<A HREF="http://www.facebook.com/pages/Canuck-Badminton/136432529861237?ref=hl" title="Like US on facebook" target="_canuckface" ><IMG SRC="images/blank2x2.gif" WIDTH=110 HEIGHT=70> </A>
					</TD>
...
<span class="globalNav" id="account" style="float: right; width: 35%" >
