...
<TABLE CELLSPACING=0 CELLPADDING=0 width="280">
  <TR valign="middle"><TD align="center" height="46">
        ...
        <span id="siteseal"><script type="text/javascript" src="https://seal.godaddy.com/getSeal?sealID=VziTO7WYlCZAAnjRr3QtT0lMK3Im4cEQ57vtz1yHIgreM5txIXu5HZWpI5xk"></script></span> 
		<img src="./images/ico_visa.jpg"/>
        </TD></TR>
          <TR valign="middle"><TD align="center" height="46">
          <A HREF="http://www.facebook.com/pages/Canuck-Badminton/136432529861237?ref=hl" target="_canuckface" >
          <IMG src="/img/facebook_canuckstuff.jpg" height="35" />
          </TD></TR>
        </TABLE>
	</td>
<?php
