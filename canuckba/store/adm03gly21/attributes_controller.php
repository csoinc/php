    ...
    case 'add_product_attributes':
      ...
      for ($i=0; $i<sizeof($_POST['values_id']); $i++) {
        ...
        if ($check_duplicate->RecordCount() > 0) {
          ...
          if (isset($_POST['attributes_image_medium']) && zen_not_null($_POST['attributes_image_medium']) && ($_POST['attributes_image_medium'] != 'none')) {
            $attributes_image_medium = new upload('attributes_image_medium');
            $attributes_image_medium->set_destination(DIR_FS_CATALOG_IMAGES . 'medium/' . $_POST['img_dir']);
          }
          if (isset($_POST['attributes_image_large']) && zen_not_null($_POST['attributes_image_large']) && ($_POST['attributes_image_large'] != 'none')) {
            $attributes_image_large = new upload('attributes_image_large');
            $attributes_image_large->set_destination(DIR_FS_CATALOG_IMAGES . 'large/' . $_POST['img_dir']);
          }
...
//get results from database option type query
$products_options_types_list = array();
$products_options_type_array = $db->Execute("select products_options_types_id, products_options_types_name from " . TABLE_PRODUCTS_OPTIONS_TYPES . " order by products_options_types_name");
...
// modified to use results of database option type query from above
        ...
        <td colspan="2"><table border="2" cellspacing="0" cellpadding="2">
          <tr>
            <td><table border="0" cellspacing="2" cellpadding="4">
              ...
              <tr>
                <td class="alert" align="center"><?php echo TEXT_INFO_ATTRIBUTES_FEATURE_COPY_TO . '<br />' . zen_draw_products_pull_down('products_update_id', 'size="5"', $products_exclude_array, true, true, true, true, true); ?></td>
            ...
            <td colspan="5">
              <table>
                <tr class="attributeBoxContent">
                  ...
                  <td class="main" valign="top"><?php echo TEXT_ATTRIBUTES_IMAGE . '(100x100)<br />' . zen_draw_file_field('attributes_image') . '<br />' . zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . $attributes_values->fields['attributes_image']  . zen_draw_hidden_field('attributes_previous_image', $attributes_values->fields['attributes_image']); ?>
                  <?php echo "<BR>Medium (200x200):" . '<br />' . zen_draw_file_field('attributes_image_medium'); ?>
                  <?php echo "<BR>Large (300x300):" . '<br />' . zen_draw_file_field('attributes_image_large'); ?>
                  </td>
...
<!--
            <td class="main" valign="top">xxx<?php echo TEXT_ATTRIBUTES_IMAGE . '(100x100)<br />' . zen_draw_file_field('attributes_image') . '<br />' . zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . $attributes_values->fields['attributes_image'] . zen_draw_hidden_field('attributes_image', $attributes_values->fields['attributes_image']); ?></td>
-->

            <td class="main" valign="top"><?php echo TEXT_ATTRIBUTES_IMAGE . '(100x100)<br />' . zen_draw_file_field('attributes_image'); ?></td>

            <td class="main" valign="top"><?php echo TEXT_ATTRIBUTES_IMAGE_DIR . '<br />' . zen_draw_pull_down_menu('img_dir', $dir_info, $default_directory); ?></td>
            <td class="main" valign="top"><?php echo TEXT_IMAGES_OVERWRITE . '<br />' . zen_draw_radio_field('overwrite', '0', $off_overwrite) . '&nbsp;' . TABLE_HEADING_NO . ' ' . zen_draw_radio_field('overwrite', '1', $on_overwrite) . '&nbsp;' . TABLE_HEADING_YES; ?></td>
          </tr>
          <tr><td colspan=2></td><td colspan=3><?php echo "Medium (200x200):" . '<br />' . zen_draw_file_field('attributes_image_medium'); ?></td></tr>
          <tr><td colspan=2></td><td colspan=3><?php echo "Large (300x300):" . '<br />' . zen_draw_file_field('attributes_image_large'); ?></td></tr>
        </table></td>
