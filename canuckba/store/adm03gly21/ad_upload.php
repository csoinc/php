  ...
  die('Illegal Access');
    ...
    if (zen_not_null($_POST)) {
      ...
      $product = $db->Execute("select p.products_id, pd.language_id, pd.products_name,
                                      ...
                                      p.products_weight,  p.products_dim_type, p.products_weight_type, p.products_length,
                                      p.products_width, p.products_height, p.products_ready_to_ship, p.products_date_added,
