  ...
  <tr>
    <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td class="pageHeading" align="right"><a href="<?php echo FILENAME_SUPER_PACKINGSLIP . '?' . zen_get_all_get_params(); ?>"><?php echo zen_image(DIR_WS_IMAGES . HEADER_LOGO_IMAGE_INVOICE, HEADER_ALT_TEXT)?></a><br /><?php echo TEXT_PACKING_SLIP; ?></td>
      </tr>
    </table></td>
  </tr>
  <tr>
...
<?php
      for ($i = 0, $n = sizeof($order->products); $i < $n; $i++) {
        ...
        echo $order->products[$i]['qty'] . '&nbsp;</td>' . "\n" .
             '        <td class="dataTableContent" valign="middle">' . $order->products[$i]['name'] . '</td><td class="dataTableContent" valign="middle">';
...
<?php if ($customer_notes) { ?>
  ...
  <tr>
    <td class="main" colspan="2"><table cellpadding=0 cellspacing=0 class="inv_comments"><tr><td><?php echo $customer_notes; ?></td></tr></table></td>
  </tr>
<?php } ?>
<?php if ($_GET['split']) { ?>
  <tr>
