...
if (menu_header_visible('Reports')=='true') {
  ...
  $options = array( array('box' => BOX_REPORTS_PRODUCTS_VIEWED, 'page' => FILENAME_STATS_PRODUCTS_VIEWED),
                    ...
                    array('box' => BOX_REPORTS_ORDERS_TOTAL, 'page' => FILENAME_STATS_CUSTOMERS_EX),
                    array('box' => BOX_REPORTS_CASH_REPORT, 'page' => FILENAME_STATS_CASH_REPORT),
                    array('box' => BOX_REPORTS_AGE_REPORT, 'page' => FILENAME_STATS_AGE_REPORT),
