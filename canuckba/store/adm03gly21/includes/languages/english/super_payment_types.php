...
define('BOX_NEW_INTRO', 'Enter the name and code that you will use to refer to this payment type.<P>Note that the code for the payment <strong>must be unique</strong>.');
