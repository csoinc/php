...
<?php
    ...
    for ($i=0, $n=sizeof($order->products); $i<$n; $i++) {
      ...
      echo '            <td class="dataTableContent" valign="middle" align="left">' . $order->products[$i]['name'];
      echo '            </td>' . "\n" . 
           '            <td class="dataTableContent" valign="middle" width="50">' . $order->products[$i]['model'] . '</td>' . "\n" .
	  	   '            <td class="dataTableContent" valign="top" width="200">';
      ...
      echo '            </td>' . "\n" .
      		'            <td class="dataTableContent" valign="middle" align="left">' . $order->products[$i]['qty'] . '</td>' . "\n" . 
...
?>
              ...
              <tr>
                ...
                <td align="right" class="<?php echo $class; ?>"><?php  echo $balance_due; ?></td>
              </tr>
              <?php if (!$so->status) { ?>
              <tr>
...
<?php
    ...
    if ($orders_history->RecordCount() > 0) {
      while (!$orders_history->EOF) {
        ...
        echo '            <td class="smallText"><table cellpadding=0 cellspacing=0 class="inv_comments"><tr><td>' . nl2br(zen_db_scrub_out($orders_history->fields['comments'])) . '&nbsp;</td></tr></table></td>' . "\n" .
             '          </tr>' . "\n";
