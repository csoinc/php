...
define('HEADING_TITLE', 'Current Stock Report');

define('TABLE_HEADING_NUMBER', 'ID#');
define('TABLE_HEADING_MODEL', 'Model');
define('TABLE_HEADING_PRODUCTS', 'Products');
define('TABLE_HEADING_VIEWED', 'Available For Sale');
define('TABLE_HEADING_REAL', 'Actual Stock');
define('TABLE_HEADING_TOBE', 'Delivery Pending');
?>