  ...
  <tr>
    <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr class="dataTableHeadingRow">
        ...
        <td class="printTableHeadingContent"><?php echo TABLE_HEADING_ATTRIBUTES; ?></td>
...
<!--        <td class="printTableHeadingContent" align="right"><?php echo TABLE_HEADING_TAX; ?></td> -->
        ...
        <td class="printTableHeadingContent" align="right"><?php echo TABLE_HEADING_TOTAL_EXCLUDING_TAX; ?></td>
      </tr>
<?php
    for ($i=0, $n=sizeof($order->products); $i<$n; $i++) {
      echo '      <tr class="dataTableRow">' . "\n";
      echo '        <td class="printTableContent" valign="middle" align="left">' . $order->products[$i]['name'] . '</td>' . "\n" .
           '        <td class="printTableContent" valign="middle">' . $order->products[$i]['model'] . '</td>' . "\n" .
	  	   ' 		<td class="printTableContent" valign="middle" align="left">' . "\n";
