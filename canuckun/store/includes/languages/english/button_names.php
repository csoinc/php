...
define('BUTTON_IMAGE_SEL_BUY', 'button_sel_buy.gif');
...
define('BUTTON_IMAGE_DETAILS', 'small_view.gif');
...
define('BUTTON_SEL_BUY_ALT', 'Select and Buy');
...
define('BUTTON_DETAILS_ALT', 'View Details');
