...
// page title
define('TITLE', 'Canuck Uniforms Store');

// Site Tagline
define('SITE_TAGLINE', 'baseball volleyball badminton uniforms shirts shorts bags Toronto Ontario Canada');

// Custom Keywords
define('CUSTOM_KEYWORDS', 'baseball volleyball badminton uniforms shirts shorts bags printing service');
