	...
	<TR>
		<TD>
			<TABLE id="main_header" CELLSPACING=0 CELLPADDING=0>
				<TR>
					<TD height="95" width="700px">
					<A HREF=<?php echo zen_href_link('index'); ?> title="Canuck Uniforms Store"><IMG SRC="images/blank2x2.gif" WIDTH=300 HEIGHT=80> </A>
					<A HREF="http://www.canuckstuff.com/store/" title="Canuck Volleyball Store"><IMG SRC="images/blank2x2.gif" WIDTH=200 HEIGHT=80> </A>
					<A HREF="http://www.canuckbadminton.com/store/" title="Canuck Badminton Store"><IMG SRC="images/blank2x2.gif" WIDTH=200 HEIGHT=80> </A>
					
					</TD>

					<td width="120px" id="account">
					<?php  //display account info
					if ($_SESSION['customer_id']) { ?> You've logged in!<br /> <a
...
<?php
        ...
        if (STORE_STATUS == '0') {
?>
             <A HREF="<?php echo zen_href_link(FILENAME_CREATE_ACCOUNT); ?>" CLASS=ml><?php echo HEADER_TITLE_CREATE_ACCOUNT; ?></A><BR />
						...
						<div class="globalNav">
							...
							<dl class="dropdown">
								...
								<dd id="products-ddcontent" onmouseover="cancelHide('products')"
									...
									<ul>
										<li><a href="/store" class="underline">Badminton</a></li>
										<li><a href="http://www.canuckstuff.com/store" class="underline">Volleyball</a></li>
									</ul>
								</dd>
							</dl>
							...
							<dl class="dropdown">
								...
								<dd id="services-ddcontent" onmouseover="cancelHide('services')"
									...
									<ul>
										<li><a href="index.php?main_page=page&id=15&chapter=30">Printing Service</a></li>
							...
							<dl class="dropdown" width="100px">
								...
								<dd id="two-ddcontent" onmouseover="cancelHide('two')"
									...
									<ul>
										<li><a href="index.php?main_page=page&id=40" class="underline">Current
												Events</a></li>
										<li><a href="index.php?main_page=page&id=4" class="underline">Past
												Events</a></li>
									</ul>
								</dd>
							</dl>
							...
							<dl class="nondropdown">
								<a href="index.php?main_page=page&id=39">Technology</a>
							</dl>
							<dl class="separator">|
							</dl>
							<dl class="nondropdown">
