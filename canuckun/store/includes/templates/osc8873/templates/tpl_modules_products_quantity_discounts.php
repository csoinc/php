...
?>
  <table border="0" cellspacing="0" cellpadding="0">
  	<tr> <td class="header_center"><?php echo TEXT_HEADER_DISCOUNTS_OFF; ?></td></tr>
    <tr>
      <td align="center">
...
<?php } else { ?>
  <table border="0" cellspacing="0" cellpadding="0">
	<tr><td class="header_center" colspan="<?php echo $columnCount+1; ?>" align="center">
<?php
...
?>
    ...
    <tr>
      <td align="center"><span class="disc_qty"><?php echo $show_qty . '</span><br />' . $currencies->display_price($show_price, zen_get_tax_rate($products_tax_class_id)); ?></td>

<?php
  $disc_cnt = 1;
  foreach($quantityDiscounts as $key=>$quantityDiscount) {
?>
<td align="center"><span class="disc_qty"><?php echo $quantityDiscount['show_qty'] . '</span><br />' . $currencies->display_price($quantityDiscount['discounted_price'], zen_get_tax_rate($products_tax_class_id)); ?></td>
<?php
    $disc_cnt++;
...
?>
    <tr>
      <td colspan="<?php echo $columnCount+1; ?>" style="font-size: 0.9em;">
