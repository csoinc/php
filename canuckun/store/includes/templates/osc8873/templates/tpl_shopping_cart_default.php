...
<div class="buttonRow back" style="vertical-align:bottom; margin: 0.1em;">
<a href="/store/index.php?main_page=page&amp;id=11"><span id="cartProdTitle">VIP Code: </span></a>
<input type="text" name="promotion_code" value="<?php echo $_SESSION['promotion_products']?>" size="20" maxlength="30" style="vertical-align: bottom; margin: 0.1em;" />
<input type="image" src="includes/templates/osc8873/buttons/english/button_update_cart.gif" alt="Input promotion code in the box, get the promotion price by clicking this button." title="Input promotion code in the box, get the promotion price by clicking this button." style="vertical-align: bottom;" /></div>
