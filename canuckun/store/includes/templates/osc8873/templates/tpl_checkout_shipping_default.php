...
function addComment(txt) {
	var objText = window.document.getElementsByTagName('textarea');
	if (objText[0].value.indexOf(txt) == -1) {
		var rt = '';
		if (objText[0].value.length != 0) 
			rt = '\n';
		objText[0].value = objText[0].value + rt + txt; 
	}
}
// -->
</script>
