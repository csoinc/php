...
define('HEADER_ALT_TEXT', 'Admin Area of Canuck Sports Stuff (Toronto) Inc.');
define('HEADER_LOGO_WIDTH', '350px');
define('HEADER_LOGO_HEIGHT', '60px');
define('HEADER_LOGO_IMAGE', 'adm_header_logo.jpg');
define('HEADER_LOGO_IMAGE_INVOICE', 'adm_header_logo_invoice.jpg');
...
define('BOX_REPORTS_CASH_REPORT', 'Cash Report 2');
define('BOX_REPORTS_AGE_REPORT', 'Age Report');
...
//defined for admin_profiles mod
