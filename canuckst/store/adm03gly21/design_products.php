...
$show.="</form><hr>";
	...
	$show.=zen_draw_form("add_image","design_products");
...
global $db;
$objresponse = new xajaxresponse();
$db->Execute("insert into ".DESIGN_PRODUCTS_IMAGES." (design_products_image_front,design_products_image_back,design_products_image_name,products_id,design_products_name) values ('".$date['add_image_front_url']."','".$date['add_image_back_url']."','".trim($date['add_image_name'])."','".$products_id."','".trim($date['add_design_name'])."')");
