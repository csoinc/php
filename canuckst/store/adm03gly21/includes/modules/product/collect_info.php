...
/* remarked by group pricing per item
...
// replaced with following section
*/ 
...
?>
          ...
          <tr>
            <td class="main"><?php echo TEXT_PRODUCTS_IMAGE; ?></td>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . 'Small (100x100)&nbsp;' . zen_draw_file_field('products_image') . '&nbsp;' . ($pInfo->products_image !='' ? TEXT_IMAGE_CURRENT . $pInfo->products_image : TEXT_IMAGE_CURRENT . '&nbsp;' . NONE) . zen_draw_hidden_field('products_previous_image', $pInfo->products_image); ?></td>
          ...
          <tr>
                ...
                <td class="main" valign="top"><?php echo "Medium (200x200): " . ' ' . zen_draw_file_field('products_image_medium'); ?></td>
	  	    	  </tr>
          <tr>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15'); ?></td>
                <td class="main" valign="top"><?php echo "Large (300x300): " . ' ' . zen_draw_file_field('products_image_large'); ?></td>
	  	    	  </tr> 
          <tr>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15'); ?></td>
                <td class="main" valign="top"><?php echo "One image for all (300x300): " . ' ' . zen_draw_file_field('products_image_one'); ?></td>
	  	    	  </tr> 
          <tr>
                <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15'); ?></td>
...
?>
          ...
          <tr bgcolor="#DDEACC">
            ...
            <td class="main"><img src="<?php echo DIR_WS_CATALOG_IMAGES; ?>shipping_canadapost.gif" alt="Canada Post Shipping Settings" border=0 /></td>
          </tr>
          <tr bgcolor="#DDEACC">
