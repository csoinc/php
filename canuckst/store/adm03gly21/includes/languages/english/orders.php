...
define('TABLE_HEADING_PAYMENT_NAME', 'Payor Name');
define('TABLE_HEADING_PAYMENT_TYPE', 'Type');
define('TABLE_HEADING_PAYMENT_NUMBER', 'Number');
define('TABLE_HEADING_PAYMENT_AMOUNT', 'Amount');
define('TABLE_HEADING_PAYMENT_ACTION', 'Action');
define('TEXT_NO_PAYMENT', 'No payment records.');
define('ACTION_ADD_PAYMENT', 'Add');
define('ACTION_EDIT_PAYMENT', 'Edit');
define('ACTION_DEL_PAYMENT', 'Delete');
...
define('BUTTON_ADD_PAYMENT', 'New Payment');
