...
<table border="0" width="100%" cellspacing="10" cellpadding="10">
  <tr>
    <td align="center" class="smallText" height="100" valign="bottom">Copyright &copy; 2005-<?php echo date('Y'); ?> Canuck Sports Stuff (Toronto) Inc. Powered by <a href="http://www.zen-cart.com" target="_blank">Zen Cart&trade;</a><br /><?php echo '<a href="' . zen_href_link(FILENAME_SERVER_INFO) . '">' . $current_sinfo . '</a>'; ?></td>
  </tr>
</table>
