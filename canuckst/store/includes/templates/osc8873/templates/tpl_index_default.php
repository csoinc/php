...
<script type="text/javascript">
	swfobject.registerObject("myId", "9.0.0", "/store/images/ad_volleyball.swf");
</script>
        
<object id="myId" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="555" height="300" vspace="100">
	<param name="movie" value="/store/images/ad_volleyball.swf" />
    <!--[if !IE]>-->
	<object type="application/x-shockwave-flash" data="/store/images/ad_volleyball.swf" width="555" height="300">
	<!--<![endif]-->
	<div>
