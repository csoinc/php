...
<h3 id="indexCategoriesHeading"><?php echo HEADING_TITLE; ?></h1>

<?php if (SHOW_CUSTOMER_GREETING == '1') { ?>
<h5 class="greeting"><?php echo zen_customer_greeting(); ?></h2>
<?php } ?>
...
<?php } else { ?>
<!--bof Category Name-->
<table cellpadding="0" cellspacing="0" class="category_header">
                <tbody><tr><td class="hd_left"></td><td class="hd_center"> &nbsp; &nbsp; <?php echo $breadcrumb->last(); ?></td><td class="hd_right"></td></tr>
               </tbody>
</table>
