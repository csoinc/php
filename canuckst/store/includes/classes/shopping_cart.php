...
class shoppingCart extends base {
  ...
  function restore_contents() {
    ...
    while (!$products->EOF) {
      $this->contents[$products->fields['products_id']] = array('qty' => $products->fields['customers_basket_quantity'],'design_array'=>base64_decode(unserialize($products->fields['customers_basket_design'])));//���design��session
