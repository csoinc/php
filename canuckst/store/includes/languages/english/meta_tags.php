...
// page title
define('TITLE', 'Canuck Sports Stuff');

// Site Tagline
define('SITE_TAGLINE', 'volleyball shoes uniforms apparel bags balls nets minuno asics overkill mikasa Toronto Ontario Canada | canuckstuff');

// Custom Keywords
define('CUSTOM_KEYWORDS', 'volleyball uniforms shoes equipment accessories shorts jerseys beachball outfit screen printing coaching');
