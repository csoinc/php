...
define('EMAIL_WELCOME', 'Welcome to <strong>' . STORE_NAME . '</strong>.');
define('EMAIL_SEPARATOR', '--------------------');
define('EMAIL_COUPON_INCENTIVE_HEADER', 'Congratulations! Here is a Discount Coupon created just for you! Please use it the next time you visit www.canuckstuff.com' . "\n\n");
