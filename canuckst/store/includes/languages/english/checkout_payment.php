...
define('TEXT_SELECT_PAYMENT_METHOD', '<span style="color:#e33">IMPORTANT: Please note that we are not equipped to process VISA DEBIT cards online.<br/>IMPORTANT: For international orders from outside continental North America, you must select "check/money order" for your payment method. We do not accept credit cards for these orders. Our agents will contact you for more information to make a bank transfer for payment. This is the only method of payment for these orders.</span>');
...
define('TEXT_SHIPPING_FEE_NOTICE', '<span style="color:#e33">IMPORTANT: The shipping rate used during this transaction will be our minimum $10.00 charge. The actual shipping charge will be added to your bill at time of shipping. The rate may increase depending on location, and size/weight of package(s).</span>');
