...
// END: moved to meta_tags.php
  ...
  define('FOOTER_TEXT_BODY', 'Copyright &copy; 2005 - ' . date('Y') . ' <a href="' . zen_href_link(FILENAME_DEFAULT) . '" target="_self">' . STORE_NAME . '</a>. All rights reserved. ');
...
// shopping_cart box text in sideboxes/shopping_cart.php
  ...
  define('BOX_SHOPPING_CART_DIVIDER', '&times;');
...
// information box text in sideboxes/information.php
  ...
  define('BOX_INFORMATION_CONDITIONS', 'Terms and Conditions of Use');
...
// End iii added
  ...
  define('TEXT_INVALID_SELECTION',' You have to select or you selected is out of stock: ');
...
// error on checkout when $_SESSION['customers_id' does not exist in customers table
  ...
  define('TABLE_HEADING_FEATURED_PRODUCTS','Hot Items');

  define('TABLE_HEADING_NEW_PRODUCTS', 'New Products For %s');
  define('TABLE_HEADING_UPCOMING_PRODUCTS', 'Upcoming Products');
  define('TABLE_HEADING_DATE_EXPECTED', 'Date Expected');
  define('TABLE_HEADING_SPECIALS_INDEX', 'Clearance Prices For %s');
